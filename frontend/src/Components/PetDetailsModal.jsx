      ...
      <div className="pet-details-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="card-content">
          ...
          <div className="pet-description">
            <p>
              This adorable {pet.breed.toLowerCase()} is looking for a loving
              forever home. {pet.name} is currently in the care of {pet.shelter}{" "}
              and is ready to meet potential adopters.
            </p>
          </div>
